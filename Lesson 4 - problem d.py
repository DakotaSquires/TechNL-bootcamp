...
reg_pill_pri_ship = 21 * int(user_input1) * 2 * tax + 60
...
if(user_input1 <10 and user_input2 == "yes"):
     ...
     print(pri_ship_cost)
     print(str("Subtotal:"))
     print(subtotal_of_reg_pill_pri_ship)
     print(str("Tax"))
    ...
    print(reg_ship_cost)
    print(str("Subtotal:"))
    print(subtotal_of_reg_pill_reg_ship)
    print(str("Tax"))
    ...
    print(reg_ship_cost)
    print(str("Subtotal:"))
    print(subtotal_of_bulk_pill_reg_ship)
    print(str("Tax"))
    ...
    print(pri_ship_cost)
    print(str("Subtotal:"))
    print(subtotal_of_bulk_pill_pri_ship)
    print(str("Tax"))
